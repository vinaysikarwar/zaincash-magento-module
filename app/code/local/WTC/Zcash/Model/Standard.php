 ...
 */
class WTC_Zcash_Model_Standard extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'zcash_standard';
    protected $_formBlockType = 'zcash/standard_form';
    ...
    {
        return Mage::getSingleton('zcash/config');
    }
    ...
    {
        return Mage::getUrl('zcash/standard/success', array('_secure' => true));
    }
    /**
    ...
    {
        return Mage::getUrl('zcash/standard/failure', array('_secure' => true));
    }
    ...
    {
        $block = $this->getLayout()->createBlock('zcash/form_standard', $name);
    ...
    public function getStandardCheckoutFormFields ()
    {
        ...
        if ($this->getConfig()->getDebug()) {
            $debug = Mage::getModel('zcash/api_debug')
